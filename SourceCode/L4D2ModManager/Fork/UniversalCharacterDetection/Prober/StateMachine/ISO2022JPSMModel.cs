...
namespace Mozilla.UniversalCharacterDetection.Prober.StateMachine
{
    public class ISO2022JPSMModel : SMModel
    {
        ...
        public ISO2022JPSMModel() : base(new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, iso2022jpClassTable), ISO2022JP_CLASS_FACTOR, new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, iso2022jpStateTable), iso2022jpCharLenTable, Constants.CHARSET_ISO_2022_JP)
        {
