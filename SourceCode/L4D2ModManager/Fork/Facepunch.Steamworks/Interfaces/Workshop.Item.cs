    ...
    public partial class Workshop
    {
        public class Item
        {
            ...
            internal static Item From( SteamNative.SteamUGCDetails_t details, Workshop workshop )
            {
                ...
                item.Title = details.Title.Decode();
                item.Description = details.Description.Decode();
            ...
            /// </summary>
            public string Url { get { return string.Format( "http://steamcommunity.com/sharedfiles/filedetails/?id={0}&searchtext=", Id ); } }
